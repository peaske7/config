...
| `<leader>oh` | n/x | toggle yellow Obsidian Highlightr `<mark>` highlight for current todo/line or selection |
...
| `<leader>oh` | toggle yellow Obsidian Highlightr `<mark>` highlight for current todo/line or selection |
